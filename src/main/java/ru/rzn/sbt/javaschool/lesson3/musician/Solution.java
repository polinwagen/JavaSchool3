...
public class Solution {
     ...
     * Музыканты
     *
     * 1. Создайте класс Vocalist в пакете ru.rzn.sbt.javaschool.lesson3.musician, подкласс {@link Musician}
     *
     * 2. Реализуйте метод sing() таким образом, чтобы последовательно и циклически возвращать следущие строки:
     * "Take me to the magic of the moment",
     * "on a glory night",
     * "Where the children of tomorrow dream away",
     * "In the Wind of Change"
     *
     * Реализуйте метод playGuitar() таким образом, чтобы вызов возращал null:
     *
    ...
    /**
     * 4. Создайте класс GuitarPlayer в пакете ru.rzn.sbt.javaschool.lesson3.musician, подкласс {@link Musician}
     *
     * 5. Реализуйте метод sing() таким образом, чтобы вызов возращал null:
     *
     * 5. Реализуйте метод playGuitar() таким образом, чтобы последовательно и циклически возвращать следущие строки:
     * "C G Dm G",
     * "C G",
     * "Dm G Am",
     * "Am/F G"
    ...
    /**
     * 7. Создайте класс GuitarPlayer в пакете ru.rzn.sbt.javaschool.lesson3.musician, подкласс {@link Musician}
     *
     * 8. Реализуйте метод sing() таким образом, чтобы последовательно и циклически возвращать следущие строки:
     * "C# G# F#"
     * "C# G# F#"
     * "Em E A5 C"
     * "Em G Em G"
     *
     * 8. Реализуйте метод playGuitar() таким образом, чтобы последовательно и циклически возвращать следущие строки:
